        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="opacity-0 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-ash font-light leading-relaxed max-w-3xl mx-auto">
              ...
              Our mission is to create modular cat furniture that seamlessly integrates with
              contemporary interiors while providing ultimate comfort for your cherished companions.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="opacity-0 animate-slide-up">
              ...
              <div className="space-y-6 text-ash leading-relaxed">
                <p>
                  The Cat Manor was born from a simple observation: cat furniture didn't have to
                  compromise on style to be functional. We saw too many pet products that, while
                  serving their purpose, disrupted the carefully curated aesthetics of modern homes.
                </p>
                <p>
                  Founded by a team of designers and devoted cat parents, we set out to bridge this
                  gap. Our journey began with a single question: "What if cat furniture could be as
                  beautiful as it is functional?"
                </p>
                <p>
                  Today, The Cat Manor stands as a testament to thoughtful design, premium
                  craftsmanship, and our unwavering commitment to enhancing the lives of both cats
                  and their humans.
                </p>
              </div>
            </div>
            <div className="opacity-0 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white p-8 rounded-lg shadow-elegant">
                ...
                <p className="text-ash leading-relaxed mb-6">
                  To craft exceptional modular cat furniture that seamlessly integrates with
                  contemporary and minimalist interiors, ensuring every piece is designed with both
                  form and feline function in mind.
                </p>
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-sm text-ash">
                    Every design decision is made with respect for both feline behavior and human
                    aesthetics.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-ash max-w-2xl mx-auto">
              These principles guide every decision we make, from initial design concepts to final
              delivery.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="opacity-0 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-6 text-ash leading-relaxed">
                <p>
                  Each piece in our collection undergoes a rigorous design and testing process. We
                  observe feline behavior patterns, study ergonomics, and test materials to ensure
                  every product meets our exacting standards.
                </p>
                <p>
                  Our commitment to quality extends beyond aesthetics. Every joint is reinforced,
                  every surface is finished to perfection, and every component is designed to
                  withstand the enthusiastic use of even the most active cats.
                </p>
                <p>
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-ash max-w-2xl mx-auto">
              We're more than just a furniture company – we're partners in creating harmonious
              living spaces.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-ash leading-relaxed mb-4">
                We believe that pet furniture should complement, not compromise, your interior
                design. Our pieces are created to be as beautiful as they are functional.
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-ash leading-relaxed mb-4">
                Your satisfaction is our priority. From initial design consultation to post-purchase
                support, we're committed to exceeding your expectations.
              </p>
              <ul className="space-y-2 text-sm text-ash">
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-deep-charcoal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Explore our curated collection and discover how modular cat furniture can enhance your
            modern living space while delighting your feline companions.
          </p>

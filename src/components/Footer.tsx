        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 max-w-md">
              Crafting exceptional modular cat furniture that seamlessly integrates with
              contemporary and minimalist interiors. Every piece is designed with both form and
              feline function in mind.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/products?collection=essential"
                  className="text-gray-300 hover:text-orange-500 transition-colors duration-300"
                >
